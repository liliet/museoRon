...
export class HistoriaPage extends AppPageOne implements OnInit {
  ...
  inicialize() {
    this.menus = [
      new MenuItem(1, 'Historia del Ron Cubano', '#', true),
      new MenuItem(2, 'Bacardí', '/historia/bacardi'),
    ...
    this.images = [
      ...
      new GalleryImage(2, `${imgsHistoryBasePath}historia1.jpg`, 'Cunyanya'),
      new GalleryImage(3, `${imgsHistoryBasePath}historia2.jpg`, 'Ruta de la caña de azúcar'),
      new GalleryImage(4, `${imgsHistoryBasePath}historia3.jpg`, 'Cunyanya')
    ];
