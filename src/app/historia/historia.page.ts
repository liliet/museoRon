...
export class HistoriaPage extends HistoriaAppPage implements OnInit {
  ...
  inicialize() {
    super.inicialize();
    this.images = [
      new GalleryImage(1, `assets${this.routeBasePath}/mapa.png`, 'Ruta de la caña de azúcar'),
      new GalleryImage(2, `assets${this.routeBasePath}/historia1.jpg`, 'Cunyanya'),
      new GalleryImage(3, `assets${this.routeBasePath}/historia2.jpg`, 'Ruta de la caña de azúcar'),
      new GalleryImage(4, `assets${this.routeBasePath}/historia3.jpg`, 'Cunyanya')
    ];
